...
import aclaudel.codurance.config.audit.AuditEventConverter;
import aclaudel.codurance.domain.PersistentAuditEvent;
...
import static aclaudel.codurance.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
